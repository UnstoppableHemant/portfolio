...
const Header = ({toggleSideNav, closeSideNav}) => {
    const navigate = useNavigate();
    return (
        <div className="flex mx-auto w-full px-6 md:px-10 py-4 items-center bg-yellow-300 justify-between z-10 drop-shadow-md">
            <div className="flex gap-6">
                <CgMenuLeft className="w-8 h-8 block md:hidden" onClick={toggleSideNav}/>
                <h3 onClick={() => {navigate("/");closeSideNav();}} className="text-3xl font-bold">Portfolio</h3>
            </div>
